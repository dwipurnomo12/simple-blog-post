    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h2>Tambah Menu Header</h2>
                        <form method="POST" action="/dashboard/menu/header/" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="link" name="link" required value="http://127.0.0.1:8000/categories/">
                                    @error('link')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($menus as $menu)
                                            <tr>
                                                ...
                                                <td>{{ $menu->link }}</td>
                                                <td> 
                                                    <form action="/dashboard/menu/header/{{ $menu->id }}" method="post" class="d-inline">
                                                        @method('delete')
                                                        @csrf
